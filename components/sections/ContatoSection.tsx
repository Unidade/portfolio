export default function ContatoSection() {
  return (
    <section className='mt-16' id='contato'>
      ...
      <div className='mt-4'>
        <p>
          Sinta-se livre para entrar em contato comigo por qualquer um dos meios
          abaixo:
        </p>
        <ul className='flex flex-wrap gap-5 mt-8'>
          <li>
            <a
              ...
              href='https://www.linkedin.com/in/dariorodriguesdev/'
            >
              <svg
                className='w-8 h-8'
                role='img'
          ...
          <li>
            <a className='flex items-center gap-2' href='tel:96999632979'>
              <svg
                role='img'
                className='w-8 h-8'
                viewBox='0 0 24 24'
          ...
          <li>
            <a
              className='flex items-center gap-2'
              href='mailto:dario.rodri123@gmail.com'
            >
              <svg
                className='w-8 h-8'
                role='img'
          ...
          <li>
            <a
              className='flex items-center gap-2'
              href='https://twitter.com/unidade_dev'
            >
              <svg
                className='w-8 h-8'
                role='img'
        ...
        <div className='mt-16'>
          <h2 className='text-2xl font-bold'>Links Relevantes</h2>
          <ul className='flex flex-wrap gap-8 mt-8'>
            <li>
              <a
                className='flex items-center gap-2'
                href='https://github.com/Unidade'
              >
                <svg
                  className='w-8 h-8'
                  role='img'
            ...
            <li>
              <a
                href='https://www.frontendmentor.io/profile/Unidade'
                className='flex items-center gap-2'
              >
                <svg
                  className='w-8 h-8'
